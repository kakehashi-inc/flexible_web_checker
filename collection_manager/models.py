...
class Collection(models.Model):
    """コレクションモデル"""
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='collections', verbose_name=_('ユーザー'))
...
class UrlItemCollection(models.Model):
    """URL項目とコレクションの中間テーブル"""
    url_item = models.ForeignKey(UrlItem, on_delete=models.CASCADE, related_name='collections', verbose_name=_('URL項目'))
    collection = models.ForeignKey(Collection, on_delete=models.CASCADE, related_name='url_items', verbose_name=_('コレクション'))
