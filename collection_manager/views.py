...
def collection_add(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('collection_manager:collection_detail', collection_id=collection.pk)
    else:
        form = CollectionForm()
...
def collection_detail(request, collection_id):
    ...
    return render(request, 'collection_manager/collection_detail.html', {
...
def collection_edit(request, collection_id):
    ...
    return render(request, 'collection_manager/collection_edit.html', {'form': form, 'collection': collection})
